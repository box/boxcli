...
describe('Device Pins', () => {
	...
	describe('device-pins:get', () => {
		...
		test
			...
			.it('should get information about an individual device pin (JSON Output)', ctx => {
		...
		test
			...
			.it('should get information about an individual device pin (YAML Output)', ctx => {
	...
	describe('device-pins:delete', () => {
		...
		test
			...
			.it('should delete individual device pin', ctx => {
				assert.equal(ctx.stderr, `Deleted device pin ${devicePinId}${os.EOL}`);
			});
	});
	...
	describe('device-pins', () => {
		...
		test
			...
			.it('should list all the device pins within a given enterprise with the direction flag passed (JSON Output)', ctx => {
