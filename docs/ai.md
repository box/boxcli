...
_See code: [src/commands/ai/ask.js](https://github.com/box/boxcli/blob/v4.8.0-beta/src/commands/ai/ask.js)_
...
_See code: [src/commands/ai/extract.js](https://github.com/box/boxcli/blob/v4.8.0-beta/src/commands/ai/extract.js)_
...
_See code: [src/commands/ai/extract-structured.js](https://github.com/box/boxcli/blob/v4.8.0-beta/src/commands/ai/extract-structured.js)_
...
_See code: [src/commands/ai/text-gen.js](https://github.com/box/boxcli/blob/v4.8.0-beta/src/commands/ai/text-gen.js)_
